<?php
    ...
    $link = mysqli_connect("localhost" , "raj" , "mysql" , "twitter");
    ...
    function displayTweets($type){
        ...
        if($type == 'public'){
            ...
            //     echo "you haven't followed anyone";
            // }
        ...
        if(mysqli_num_rows($result) == 0){
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<div class='tweet'><p><a href='?page=publicprofile&userid=".$user['id']."'>".$user['email']."</a></p>";
                echo "<p>".$row['tweet']."</p>";
                echo "<p><a class='toggleFollow' data-userId='".$row['userid']."' href='#'>";
                    ...
                    if(!$isFollowingQueryResult || mysqli_num_rows($isFollowingQueryResult) > 0){
                        echo "Unfollow";
                    }else{
                        echo "Follow";
                    }
    ...
    function displaySearch(){
            echo'<form class="form-inline">
                ...
                <button type="submit" class="btn btn-primary"  style="margin-left:10px">Search Tweets</button>
            </form>';
    }
    ...
    function displayTweetBox(){
        ...
        if(array_key_exists('id' , $_SESSION) && $_SESSION['id'] > 0){
            echo'<div id="tweetSuccess" class="alert alert-success" role="alert">Your tweet is posted successfully.</div>
                 <div id="tweetFail" class="alert alert-danger" role="alert"></div><div class="form">
                <div class="form-group">
                    <textarea class="form-control" id="tweetContent"></textarea>
                </div>
                <button class="btn btn-primary"  id="postTweetButton" style="margin-left:10px">Post Tweet</button>
            </div>';
